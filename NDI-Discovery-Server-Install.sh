...
EOD
###
### Un-comment this next line if you want the server to reset every night at midnight.
### I don't want to do this since I'm writing this for a tour that often is playing at Midnight.
###
...
cron_command="1 0 * * * /root/ndi-discovery-server-log-archive.sh
echo "$cron_command" | crontab -"

#Delete the default apache index.html file and create index.html file that loads the reversed log file, does some formatting, sets it to refresh every 5 seconds and adds a button to pause refrheses
